...
Original file is located at
    https://colab.research.google.com/drive/10xPS9iRKZjAb0XPky-wxa_xEx8hYpjvN

# About this notebook
Inference from a saved pre-trained model using Pytorch and Huggingface

- Based on open source version of https://www.kaggle.com/code/yasufuminakama/fb3-deberta-v3-base-baseline-inference 

Training notebook is [https://www.kaggle.com/code/yasufuminakama/fb3-deberta-v3-base-baseline-train](https://www.kaggle.com/code/yasufuminakama/fb3-deberta-v3-base-baseline-train)
"""
...
CFG.path = save_model_dir
CFG.config_path = save_model_dir + "/config.pth"
...
display(submission.head())
submission[['text_id'] + CFG.target_cols].to_csv(save_dir + '/submission.csv', index=False)