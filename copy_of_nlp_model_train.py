# -*- coding: utf-8 -*-
"""Copy of NLP-model-train.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16TffeOYO8IGu1j6PmKy2q9C14fVaCqWN
...
class CFG:
    ...
    num_cycles=0.5
    num_warmup_steps=1
    epochs=4 #internet says epoch should be 3x the size of target_cols
    encoder_lr=.98e-5
    decoder_lr=.98e-5
    min_lr=1e-6
    eps=1e-6
    ...
    max_grad_norm=750 #originally 1000
    target_cols=['cohesion', 'syntax', 'vocabulary', 'phraseology', 'grammar', 'conventions']
    seed=1916 #originally 42
    n_fold=4
    trn_fold=[0, 1, 2, 3]
    #trn_fold=[0, 1]
    train=True
...
# ====================================================
# CV split cross validation folds
# ====================================================
...
# ====================================================
tokenizer = AutoTokenizer.from_pretrained(CFG.model) #if is a fast model then remove use_fast=True
...
def train_loop(folds, fold):
    ...
    # loop
    # ====================================================
    criterion = nn.SmoothL1Loss(reduction='mean', beta=0.025) # RMSELoss(reduction="mean")
